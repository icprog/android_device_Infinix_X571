...
$(call inherit-product-if-exists, vendor/Infinix/X571/X571-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/Infinix/X571/overlay
PRODUCT_PACKAGE_OVERLAYS += device/Infinix/X571/overlay
...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_MODEL="Infinix X571"
